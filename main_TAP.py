...
def main(args):
    ...
    for iteration in range(1, attack_params['depth'] + 1): 
        ...
        # print(extracted_attack_list, convs_list)
        adv_prompt_list = [attack["prompt"] for attack in extracted_attack_list]
        improv_list = [attack["improvement"] for attack in extracted_attack_list]
        # print(f'Generated {len(adv_prompt_list)} adversarial prompts.', flush=True)
        # print(adv_prompt_list)
        # print(improv_list, "Finished getting adversarial prompts.", flush=True)
        ############################################################
        #   PRUNE: PHASE 1        print(adv_prompt_list, improv_list, flush=True)
        ############################################################
        ...
        ############################################################
        print("###############################################################")
        print("Prompts to be sent to target model:", adv_prompt_list)
        print("###############################################################")
        target_response_list = target_llm.get_response(adv_prompt_list)
        print("Finished getting target responses.", target_response_list) 
        ...
        print("Finished getting judge scores from evaluator.", judge_scores)
